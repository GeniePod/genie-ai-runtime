...
**`v1.3.1`** — **Gemma 4 E2B** support plus a decode cycle and **split-K decode
attention** that beats llama.cpp decode at every context depth (**1.1–1.6×**),
and **fused short-prefill attention** (**~2× faster** TTFT for typical
short prompts). See
...
| [`CHANGELOG.md`](CHANGELOG.md)                          | Per-release notes alpha.0 → v1.3.1 |
