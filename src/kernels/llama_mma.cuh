// llama_mma.cuh — VENDORED from llama.cpp ggml/src/ggml-cuda/mma.cuh (MIT).
// The MMA tile<> abstraction + ldmatrix-based shared->register operand loads
// that genie's hand-written kernels lacked. Verbatim except: the original
// `#include "common.cuh"` is replaced by llama_compat.cuh (the minimal subset
// of macros/helpers this file needs). Do not edit the tile<>/mma/ldmatrix
// bodies — keeping them faithful is the whole point of the port.
#pragma once
#include "llama_compat.cuh"
